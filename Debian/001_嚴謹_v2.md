...
# 只開放 Grafana 主機來存取
iptables -I INPUT -p tcp -m tcp -s 192.168.88.250 --dport 8086 -j ACCEPT
iptables -I INPUT -p tcp -m tcp -s 192.168.88.250 --dport 8086 -j ACCEPT
iptables -I INPUT -p tcp -m tcp -s 192.168.88.250 --dport 8086 -j ACCEPT
...
# 開放對SNMP去的監控主機
iptables -A OUTPUT -p udp --dport 161 -d 192.168.88.166 -j ACCEPT
iptables -A OUTPUT -p udp --dport 161 -d 192.168.88.167 -j ACCEPT
iptables -A OUTPUT -p udp --dport 161 -d 192.168.88.168 -j ACCEPT
#
